#####Modificaciones Fausto Andre Valenzuela 19-NOV-2020
...
while True:
    ...
    #Cambiado el valor a True para una configuracion de resistencias Pull up
    if GPIO.input(shutdown_pin)== True:
        #print("hola")
        shut_down()
