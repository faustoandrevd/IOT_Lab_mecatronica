...
#define WLAN_SSID       "INFINIT*****"

#define WLAN_PASS       "elinternet***********"
...
#define AIO_KEY         "aio_vkUW63k9bHnJQ9q3***********"

int output=23;
int output2=22; //nuevo
...
Adafruit_MQTT_Subscribe *subscription;
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (subscription == &Project) {
      ...
      else if (!strcmp((char*) Project.lastread, "OF"))
      ...
      //nuevo
      else if (!strcmp((char*) Project.lastread, "PI")){
          digitalWrite(22, HIGH);
          delay(2000); //espera 1 segundo antes de apagarlo
          digitalWrite(22,LOW);
        }
